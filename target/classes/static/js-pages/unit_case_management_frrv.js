		...
		.ready(
				function() {
					...
					var datatable_cordinator = $(
							"#job_casemgtdetailsdataTable_frrv").DataTable(
							{
								stateSave : true,
					...
					var datatable = $(
							"#job_casemgtdetailsdataTable__supervisor_frrv")
							.DataTable(
									{
										stateSave : true,
										"createdRow" : function(row, data,
												dataIndex) {
											if (data[6] >= "3" && data[6] < "5") {
												$(row).addClass(
														'tr-passed-3-days');
											} else if (data[6] >= "5"
													&& data[6] < "7") {
							...
							.click(
									function(event) {
										...
										if (inbox_type == 1 || inbox_type == 3) {
											...
											request_type = 'load_applications_at_unit_by_inbox_type_frrv_coordinator';
										}
										...
										$
												.ajax({
													...
													success : function(
														...
														/*
														 * var table =
														 * $('#job_casemgtdetailsdataTable_frrv');
														 * table.find("tbody
														 * tr").remove();
														 */
																		...
																		function() {
																			...
																			datatable_cordinator.row
																					.add(
																							...
																							/*
																							 * '<form
																							 * action="registration_application_progress_details_frrv"
																							 * method="post">' + '<input
																							 * type="hidden"
																							 * name="case_number"
																							 * id="case_number"
					...
					$(".btnLoadSupervisor_applicstions_frrv")
							.click(
									function(event) {
										// console.log('Clicked
										// btnLoadUnitApplicationsfrrv');
										...
										request_type = 'load_applications_at_unit_by_inbox_type_frrv';
																			...
																			datatable.row
																					.add(
																							[
																									...
																									'<form action="registration_application_progress_details_frrv" method="post">'
									...
									function(e) {
										...
										if (job_purpose) {
											...
											if (confirm(confirmText)) {
												$(
														"#job_casemgtdetailsdataTable_frrv input[type=checkbox]:checked, #job_detailsdataTable input[type=checkbox]:checked")
														.each(
																function() {
																	var row = $(
																			this)
							...
							.on(
									...
									function(e) {
										...
										if (job_purpose) {
											...
											if (confirm(confirmText)) {
												$(
														"#job_casemgtdetailsdataTable__supervisor_frrv input[type=checkbox]:checked")
														.each(
																function() {
																	var row = $(
																			this)
					...
					$('#btnSendAllForfrrv')
							.on(
									'click',
									function(e) {
										if ($("#job_casemgtdetailsdataTable_frrv input[type=checkbox]:checked").length > 0) {
											// any one is checked

											var confirmText = "Are you sure you want to move these applications for FRRV?";
											console.log('How how are you');
														...
														.ajax({
															...
															success : function(
																...
																$
																		.notify(
																				{
																					message : '<i class="fa fa-exclamation  fa-3x fa-fw"></i><span class="text-bold">Success! Jobs sent to all divisions for FRRV <br><br></span>',
																				},
																				{
							...
							.on(
									...
									function(e) {
										...
										if ($("#job_casemgtdetailsdataTable_frrv input[type=checkbox]:checked").length > 0) {
											...
											var confirmText = "Do you want to move all selected jobs to next Milestone? This action will notify clients that FRRV completed and connot be reversed";
											// console.log('How how are you');
														...
														if (result) {
															...
															$
																	.ajax({
																		...
																		url : "Case_Management_Serv",
																		data : {
																			request_type : 'select_update_application_as_work_done_frrv',
																			job_number : job_number,
