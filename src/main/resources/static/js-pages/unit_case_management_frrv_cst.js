		...
		.ready(
				function() {
					...
					var datatable_cordinator = $(
							"#job_casemgtdetailsdataTable_frrv_cst").DataTable(
							{
								stateSave : true,
					...
					var datatable = $(
							"#job_casemgtdetailsdataTable__supervisor_frrv_cst")
							.DataTable(
									{
										stateSave : true,
					...
					$(".btnLoadUnitApplicationsfrrvcst")
							.click(
									function(event) {
										// console.log('Clicked
										// btnLoadUnitApplicationsfrrvcst');
										...
										if (inbox_type == 1 || inbox_type == 3) {
											...
											request_type = 'load_applications_at_unit_by_inbox_type_frrv_cst_coordinator';
										}
										...
										$
												.ajax({
													...
													success : function(
														...
														/*
														 * var table =
														 * $('#job_casemgtdetailsdataTable_frrv_cst');
														 * table.find("tbody
														 * tr").remove();
														 */
																		...
																		function() {
																			...
																			datatable_cordinator.row
																					.add(
																							...
																							/*
																							 * '<form
																							 * action="registration_application_progress_details_frrv_cst"
																							 * method="post">' + '<input
																							 * type="hidden"
																							 * name="case_number"
																							 * id="case_number"
					...
					$(".btnLoadSupervisor_applicstions_frrv_cst")
							.click(
									function(event) {
										// console.log('Clicked
										// btnLoadUnitApplicationsfrrvcst');
										...
										request_type = 'load_applications_at_unit_by_inbox_type_frrv_cst';
																			...
																			datatable.row
																					.add(
																							[
																									...
																									'<form action="registration_application_progress_details_frrv_cst" method="post">'
																											+ '<input type="hidden" name="case_number" id="case_number" value="'
																											+ this.transaction_number
																											+ '">'
																											+ '<input type="hidden" name="transaction_number" id="transaction_number" value="'
									...
									//	console.log('How how are you');
										if (job_purpose) {
											...
											if (confirm(confirmText)) {
												$(
														"#job_casemgtdetailsdataTable_frrv_cst input[type=checkbox]:checked, #job_detailsdataTable input[type=checkbox]:checked")
														.each(
																function() {
																	var row = $(
																			this)
					...
					$('#btnAddAlltoBatchlistforsupervisorFRRVCST')
							.on(
									'click',
									function(e) {
										var job_purpose = $(
										...
										if (job_purpose) {
											...
											if (confirm(confirmText)) {
												$(
														"#job_casemgtdetailsdataTable__supervisor_frrv_cst input[type=checkbox]:checked")
														.each(
																function() {
																	var row = $(
																			this)
					...
					$('#btnAddAlltoBatchlistforsupervisor_to_cordinator_FRRV_CST')
							.on(
									'click',
									function(e) {
										var job_purpose = $(
										...
										if (job_purpose) {
											...
											if (confirm(confirmText)) {
												...
												$(
														'#viewBatchlistModal #lbl_batch_type')
														.val(
																'frrv_cst_supervisor_to_cordinator');
											}
										} else {
					...
					$('#viewRecordsInfoModal')
							.on(
									...
									$('#btnSendAllForfrrvcst')
									.on(
											'click',
											function(e) {
												if ($("#job_casemgtdetailsdataTable_frrv_cst input[type=checkbox]:checked").length > 0) {
													// any one is checked
		
													var confirmText = "Are you sure you want to move these applications for RV?";
													console.log('How how are you');
					...
					$('#btnAddAlltofinishedList_frrv_cst')
							.on(
									'click',
									function(e) {
										// var job_purpose =
										...
										if ($("#job_casemgtdetailsdataTable_frrv_cst input[type=checkbox]:checked").length > 0) {
											...
											var confirmText = "Do you want to move all selected jobs to next Milestone? This action will notify clients that frrv/cst completed and connot be reversed";
											// console.log('How how are you');
											...
											if (confirm(confirmText)) {
												...
												$
														.ajax({
															...
															url : "Case_Management_Serv",
															data : {
																request_type : 'update_job_step_status_bulk_frrv_cst',
														...
														if (result) {
															...
															$
																	.ajax({
																		...
																		url : "Case_Management_Serv",
																		data : {
																			request_type : 'select_update_application_as_work_done_frrv_cst',
																			job_number : job_number,
							...
							.on(
									...
									function(e) {
										...
										$
												.ajax({
													...
													url : "Case_Management_Serv",
													data : {
														request_type : 'select_approve_job_note_frrv_cst',
														job_number : job_number,
														job_purpose: job_purpose
									...
									.on(
											...
											.on(
													...
													function(e) {
														...
														$
																.ajax({
																	...
																	url : "Case_Management_Serv",
																	data : {
																		request_type : 'select_approve_job_note_frrv',
																		job_number : job_number,
																		job_purpose : job_purpose
													...
													$('#_check_frrv_cst_application_status').on('click', function(e){
														e.preventDefault();
														var job_number = $('#up_frrv_cst_job_number').val();
														...
														$
																.ajax({
																	...
																	url : "Case_Management_Serv",
																	data : {
																		request_type : 'select_confirm_frrv_cst_searches_from_division',
																		job_number : job_number
																	...
																	success : function(
																		...
																		document.getElementById('_html_pvlmd_badge_corp').innerHTML = _html_pvlmd_badge;
																		document.getElementById('_html_smd_badge_corp').innerHTML = _html_smd_badge;
																		document.getElementById('_html_lrd_badge_corp').innerHTML = _html_lrd_badge;
				
																		if(pvlmd_status == 1 && smd_status == 1 && lrd_status == 1 ) {
																			$('#btn_update_app_status_frrv_cst').show()
																		} else {
																			$('#btn_update_app_status_frrv_cst').hide()
																		}
													...
													$('#btn_update_app_status_frrv_cst').on('click', function(e){
														e.preventDefault();
														var job_number = $('#up_frrv_cst_job_number').val();
														...
														if (confirm(confirmText)) {
															...
															$.ajax({
																...
																url : "Case_Management_Serv",
																data : {
																	request_type : 'select_upddate_frrv_cst_searches_as_completed_from_division',
																	job_number : job_number
