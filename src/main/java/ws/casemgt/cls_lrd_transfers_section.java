...
public class cls_lrd_transfers_section {

	public String select_lrd_transfers_section_all_by_case_number(String web_service_url, String web_service_api_key,
			String json_request) {
	...
	public String select_lrd_transfers_section_add_and_update(String web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
		try {
			Client client = Client.create();
