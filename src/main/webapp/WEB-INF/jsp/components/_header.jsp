                            ...
                            <div class="d-flex align-items-start gap-3">
                                 <div class="lh-1">
                                     <span class="avatar avatar-sm avatar-rounded bg-primary-transparent">
                                        <img src="${pageContext.request.contextPath}/assets/images/faces/1.jpg" alt="">
                                     </span>
                                 </div>
                                 <div class="flex-fill">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <ul class="list-unstyled mb-0 sub-list">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="#"><i class="ti ti-user-circle me-2 fs-18"></i>Profile Settings</a>
                                </li>
                            </ul>        
                        </li>
                        <li>
