            ...
            <div class="fxt-form-content">
                <div class="fxt-main-form">
                    <div class="fxt-inner-wrap fxt-opacity fxt-transition-delay-13">
                        <h2 class="fxt-page-title">Forgot Passowrd</h2>
                        <p class="fxt-description">Enter your username to reset your password</p>
                        ${login == 'failed' ? '
                        ...
                        <form name="loginForm" method="POST" action="send_code_for_password_reset">
                            <div class="form-group">
                                ...
                                <input type="type" id="username" class="form-control" name="username" placeholder="Enter Username" required="required">
                            </div>
                            
                            
                            <div class="form-group mb-3">
                                <button type="submit" class="fxt-btn-fill">Send Code</button>
                            </div>
                            <div class="form-group">
