...
#focal_person_archived_search{
display:none;
}

#replies_archived_search{
display:none;
}
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1" id="notificationSection">
              <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter" id="notificationBadgeCounter_cica" style="display:none" ></span>
              </a>
              <!-- Dropdown - Alerts -->
