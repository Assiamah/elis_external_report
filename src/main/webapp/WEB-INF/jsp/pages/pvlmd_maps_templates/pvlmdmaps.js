...
document.getElementById('pvlmd_btn_show_location').addEventListener(
		'click',
		function(e) {

			/*
			 * var radioValue = $( "input[name='interaction_type']:checked")
			 * .val();
			 * 
			 * if (radioValue) {
			 * 
...
document.getElementById('pvlmd_btn_visualise_coordinate').addEventListener(
		'click',
		function() {
			...
			$('#pvlmd_bl_wkt_polygon').val(polygon_tttt);
			// var wktplygonsearch =
			...
			pvlmd_map.getView().fit(
					pvlmd_lc_searchLayer.getSource().getExtent(), {
...
document
		.getElementById('pvlmd_btn_visualise_search')
		.addEventListener(
				'click',
				function() {
...
document
		...
		.addEventListener(
				...
				function(e) {
					...
					var remarks = document.getElementById("pvlmd_remarks_fts").value;
...
document
		.getElementById('btn_save_pvlmd_parcel_details')
		.addEventListener(
				'click',
				function(e) {
					// wktplygonsearch
					...
					var gid = document.getElementById("pvlmd_gid").value;

					var file_number = document
							.getElementById("pvlmd_file_number").value;
					var reference_number = document
							.getElementById("pvlmd_reference_number").value;

					var property_number = document
							.getElementById("pvlmd_property_number").value;
					var cro_reference = document
							.getElementById("pvlmd_cro_reference").value;

					var plot_number = document
							.getElementById("pvlmd_plot_number").value;
					var locality = document.getElementById("pvlmd_locality").value;

					var sheet_number = document
							.getElementById("pvlmd_sheet_number").value;
					var remarks = document.getElementById("pvlmd_remarks").value;
					...
					$.ajax({
						...
						// target : '_blank',
						data : {
							request_type : 'select_update_pvlmd_parcels',
							gid : gid,
							sheet_number : sheet_number,
							file_number : file_number,
						...
						success : function(jobdetails) {
							 ...
							 * "#pvlmdparcelinformation") .modal(); $(
							 * '#pvlmdparcelinformation #pvlmd_gid')
							 * .val(json_p.gid); $( '#pvlmdparcelinformation
							 * #pvlmd_reference_number') .val(
							 * json_p.reference_number); $(
							 * '#pvlmdparcelinformation #pvlmd_nt_number') .val(
							 * json_p.nt_number);
							 */
...
document
		.getElementById('btn_save_pvlmd_transaction_short')
		.addEventListener(
				'click',
				function(e) {
					// wktplygonsearch
					...
					var pvlmd_gid = document.getElementById("pvlmd_gid").value;
					...
					var term = document.getElementById("pvlmd_tr_st_term").value;
					...
					var remarks = document.getElementById("pvlmd_tr_remarks").value;
...
document.getElementById('#addpvlmdtransactionlong').on(
		'show.bs.modal',
		function(event) {
			...
			$("#pvlmd_tr_reference_number").val(
					$("#pvlmd_reference_number").val());
			$("#pvlmd_tr_nt_number").val($("#pvlmd_nt_number").val());
			$("#pvlmd_tr_file_number").val($("#pvlmd_file_number").val());
			$("#pvlmd_tr_cro_reference").val($("#pvlmd_cro_reference").val());
...
document
		.getElementById('pvlmd_tr_btn_save_transaction_long')
		.addEventListener(
				'click',
				function(e) {
					// wktplygonsearch
					...
					var term = document.getElementById("pvlmd_tr_term").value;
					var commencement_date = document
							.getElementById("pvlmd_tr_commencement_date").value;
					var purpose = document.getElementById("pvlmd_tr_purpose").value;
					...
					var premium = document.getElementById("pvlmd_tr_premium").value;
...
document.getElementById('pvlmd_btn_visualise_wkt').addEventListener(
		'click',
		function(e) {
			// wktplygonsearch
			// v
...
document
		.getElementById('pvlmd_btn_search_by_reference_number')
		.addEventListener(
				'click',
				function(e) {
								...
								success : function(jobdetails) {
									...
									if (json_p !== undefined || json_p !== null) {
										...
										if (pvlmd_lc_searchLayer.getSource() != null) {
											pvlmd_lc_searchLayer.getSource()
													.clear();
										}
...
document.getElementById('pvlmd_btn_load_for_scanned_maps').addEventListener(
		'click',
		function(e) {
...
document
		.getElementById('pvlmd_btn_search_transaction')
		.addEventListener(
				'click',
				function(e) {
...
document
		.getElementById('#pvlmdparcelinformation')
		.addEventListener(
				'show.bs.modal',
				function(e) {

					var parcel_uuid = $(e.relatedTarget).data('parcel_uuid');
					var reference_number = $(e.relatedTarget).data(
							'reference_number');

					/*
					 * remarks, sheet_number, file_number, property_number,
					 * reference_number, locality, plot_number, cro_reference,
					 * nt_number, parcel_uuid
					 */

					$('#pvlmdparcelinformation #pvlmd_gid').val(parcel_uuid);

					$('#pvlmdparcelinformation #pvlmd_reference_number').val(
							$(e.relatedTarget).data('reference_number'));

					$('#pvlmdparcelinformation #pvlmd_nt_number').val(
							$(e.relatedTarget).data('nt_number'));
					$('#pvlmdparcelinformation #pvlmd_file_number').val(
							$(e.relatedTarget).data('file_number'));

					$('#pvlmdparcelinformation #pvlmd_cro_reference').val(
							$(e.relatedTarget).data('cro_reference'));

					$('#pvlmdparcelinformation #pvlmd_property_number').val(
							$(e.relatedTarget).data('property_number'));
					$('#pvlmdparcelinformation #pvlmd_locality').val(
							$(e.relatedTarget).data('locality'));

					$('#pvlmdparcelinformation #pvlmd_sheet_number').val(
							$(e.relatedTarget).data('sheet_number'));

					$('#pvlmdparcelinformation #pvlmd_plot_number').val(
							$(e.relatedTarget).data('plot_number'));
					$('#pvlmdparcelinformation #pvlmd_remarks').val(
							$(e.relatedTarget).data('remarks'));
...
document
		...
		.addEventListener(
				...
				function(e) {
					...
					var canvas = document.getElementById("pvlmd-map")
