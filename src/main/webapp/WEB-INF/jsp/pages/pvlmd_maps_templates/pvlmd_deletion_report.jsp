   ...
   <div class="container-fluid">
	<section class="section dashboard">
		                ...
		                <div class=" ">
					         ...
					         <nav>
				                <ol class="breadcrumb">
				                  ...
				                  <li class="breadcrumb-item active">PVLMD Amendment Report </li>
				                </ol>
			               </nav>
        ...
        <div class="col-lg-12">
          <div class="row">
            <!-- Assigned Cases Card -->
            <div class="col-xl-3 col-md-6" id="track_requested_amendment">
			...
			<div class="col-xl-3 col-md-6" id="generate_requested_activities">			 
				<div class="card border-left-warning shadow h-100 py-2" id="body-bg-3">
  
				  <div class="card-body">
		  
					  <h5 class="card-title">Generate Activities</h5>
			  ...
			  <div class="col-xl-3 col-md-6" id="parcel_requested_deleted">			 
				<div class="card border-left-success shadow h-100 py-2" id="body-bg-2">
  
				  <div class="card-body">
		  
					  <h5 class="card-title">Parcel [<small>Amended</small>]</h5>
					  ...
					  <div class="d-flex align-items-center">
						  ...
						  <div class="ml-2">
							<h4 id="deletion_approved_count"><c:out value="${parcel_deleted_count}"></c:out></h4>
			  ...
			  <div class="col-xl-3 col-md-6" id="transaction_requested_deleted">			 
				<div class="card border-left-success shadow h-100 py-2" id="body-bg-4">
  
				  <div class="card-body">
		  
					  <h5 class="card-title">Transaction [<small>Amended</small>]</h5>
					  ...
					  <div class="d-flex align-items-center">
						  ...
						  <div class="ml-2">
							<h4 id="deletion_approved_count"><c:out value="${transaction_deleted_count}"></c:out></h4>
		 ...
		 <div class="row mb-4 d-none" id="track_request">
		 		<div class="col-md-9">
						          ...
						          <div class="form-group">
						            <div class="form-row mb-4">
						              ...
						              <div class="col-md-3">
						                ...
						                <button type="button" class="btn btn-warning" value="Search" id="btnTrackRequest" ><i class="fas fa-search"></i> Search </button>
			...
			<div class="row mb-4 d-none" id="generate_request">
				<div class="col-md-4">
									
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col">
                                <label for="pvlmd_reference_number_fts">From Date: <span class="text-danger">*</span></label> <input
                                    class="form-control " type="date"
                                    placeholder="" id="from_date_idr"
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col">
                                <label for="pvlmd_reference_number_fts">To Date: <span class="text-danger">*</span></label> <input
                                    class="form-control " type="date"
                                    placeholder="" id="to_date_idr"
                                ...
                                >
                                   ...
                                   <button class="btn btn-success w-100" id="btn_generate_amendment_request">
        ...
        <div class="row mb-4 d-none" id="track_request_tab">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content mt-4">
                        <div id="" class="table-responsive">
                            <table class="table " id="table_amendment_requested"  width="100%" cellspacing="0" style="text-transform: uppercase;">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Reference No.</th>
	      ...
	      <div class="row mb-4 d-none" id="parcel_table_tab">
	            <div class="col-md-12">
	              <div class="card">
	              	<div class="card-header bg-dark text-white">
