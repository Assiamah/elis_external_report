   ...
   <div class="container-fluid">
	<section class="section dashboard">
		                ...
		                <div class=" ">
					         ...
					         <nav>
				                <ol class="breadcrumb">
				                  ...
				                  <li class="breadcrumb-item active">PVLMD Amendment Review </li>
				                </ol>
			               </nav>
        ...
        <div class="col-lg-12">
          <div class="row">
            <!-- Assigned Cases Card -->
            <div class="col-xl-4 col-md-6" id="parcel_deletion_requested_approval">
              <div class="card border-left-info shadow h-100 py-2" id="body-bg-1">

                <div class="card-body">
	                  		<h5 class="card-title">Parcel [<small>Amendment Requested</small>]</h5>
			...
			<div class="col-xl-4 col-md-6" id="transaction_deletion_requested_approval">			 
				<div class="card border-left-warning shadow h-100 py-2" id="body-bg-3">
  
				  <div class="card-body">
		  
					  <h5 class="card-title">Transaction [<small>Amendment Requested</small>]</h5>
