   ...
   <div class="container-fluid">
	<section class="section dashboard">
		                ...
		                <div class=" ">
					         ...
					         <nav>
				                <ol class="breadcrumb">
				                  ...
				                  <li class="breadcrumb-item active">PVLMD Amendment Approval </li>
				                </ol>
			               </nav>
        ...
        <div class="col-lg-12">
          <div class="row">
            <!-- Assigned Cases Card -->
            <div class="col-xl-4 col-md-6" id="parcel_deletion_requested_reviewed">
              <div class="card border-left-info shadow h-100 py-2" id="body-bg-1">

                <div class="card-body">
	                  		<h5 class="card-title">Parcel [<small>Amendment Reviewed</small>]</h5>
							...
							<div class="d-flex align-items-center">
								<div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
								 ...
								 <div class="ml-2">	
		                     	 	<h4 id="deletion_request_count"><c:out value="${parcel_delete_review_count}"></c:out></h4>
								 </div>
		                    </div>
                </div>
			...
			<div class="col-xl-4 col-md-6" id="transaction_deletion_requested_reviewed">			 
				<div class="card border-left-warning shadow h-100 py-2" id="body-bg-3">
  
				  <div class="card-body">
		  
					  <h5 class="card-title">Transaction [<small>Amendment Reviewed</small>]</h5>
					  ...
					  <div class="d-flex align-items-center">
						  ...
						  <div class="ml-2">
							<h4 id="deletion_approved_count"><c:out value="${transaction_delete_review_count}"></c:out></h4>
			  ...
			  <!-- <div class="col-xl-3 col-md-6" id="transaction_deletion_approved">			 
				<div class="card border-left-success shadow h-100 py-2" id="body-bg-4">
				  ...
				  <div class="card-body">
					  ...
					  <h5 class="card-title">Transaction [<small>Deletion Approval</small>]</h5>
		 ...
		 <!-- <div class="row mb-4" id="parcel_search">
		 		<div class="col-md-9">
								 	
							    
								    <div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" id="rbtn_search_type1" name="rbtn_search_type" class="custom-control-input rbtn_search_type" value="parcel_number" required>
									  <label class="custom-control-label" for="rbtn_search_type1">Parcel Number</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" id="rbtn_search_type2" name="rbtn_search_type" class="custom-control-input rbtn_search_type" value="job_number" required>
									  <label class="custom-control-label" for="rbtn_search_type2">File Number</label>
									</div>
									<br><br>
...
<!-- 
		 <div class="row mb-4 d-none" id="transaction_search">
			<div class="col-md-9"> -->
							   ...
							   <div class="custom-control custom-radio custom-control-inline">
								 <input type="radio" id="rbtn_search_type2" name="rbtn_search_type" class="custom-control-input rbtn_search_type" value="job_number" required>
								 <label class="custom-control-label" for="rbtn_search_type2">Job Number</label>
							   </div> -->
							   <!-- <br>
							 <div class="form-group">
							   <div class="form-row mb-4">
	              ...
	              <div class="card">
	                ...
	                <div class="card-body">
	                	  <h5 class="card-title"><span id="card_title"> </span></h5>
								<!-- <div class="row col-md-5 d-none" id="parcel_tab">
									<select class="form-control" type="text" id="parcel_layer_type_for_approval">
										<option disabled selected value="">-- select layer --</option>
										<option value="pvlmd_layer">PVLMD</option>
										<option value="cro_layer">CRO</option>
										<option value="garro_layer">GARRO</option>
									</select>
								</div>
		
								<div class="tab-content mt-4 d-none" id="pvlmd_parcel_tab">
								...
								<div class="tab-content mt-4 d-none" id="garro_parcel_tab">
									<div id="" class="table-responsive">
								...
								<div class="tab-content mt-4 d-none" id="cro_parcel_tab">
									<div id="" class="table-responsive">
								...
								<div class="d-none text-small" id="accordion_p">
									<div class="card">
									  <div class="card-header" id="headingOne">
										<h5 class="mb-0">
										  <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne-r" aria-expanded="true" aria-controls="collapseOne">
											PVLMD Parcel
										  </button>
										</h5>
									  </div>
								  
									  <div id="collapseOne-r" class="collapse" aria-labelledby="headingOne" data-parent="#accordion_p">
										<div class="card-body">
									...
									<div class="card">
									  <div class="card-header" id="headingTwo">
										<h5 class="mb-0">
										  <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo-r" aria-expanded="false" aria-controls="collapseTwo">
											GARRO Parcel
										  </button>
										</h5>
									  </div>
									  <div id="collapseTwo-r" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_p">
										<div class="card-body">
									...
									<div class="card">
									  <div class="card-header" id="headingThree">
										<h5 class="mb-0">
										  <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree-r" aria-expanded="false" aria-controls="collapseThree">
											CRO Parcel
										  </button>
										</h5>
									  </div>
									  <div id="collapseThree-r" class="collapse" aria-labelledby="headingThree" data-parent="#accordion_p">
										<div class="card-body">
