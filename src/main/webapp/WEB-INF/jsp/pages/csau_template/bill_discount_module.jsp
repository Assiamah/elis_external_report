        ...
        <div class="col-lg-7">
		 ...
		 <div class="card mb-3">
            <div class="card-header">
            	<h3 class="text-primary">Land Commission Bills Discount</h1>
            </div>
            ...
            <div class="card-body"> 				     
	               <div class="form-group">
							<div class="form-row">
								<div class="col-sm-7">
									<input class="form-control" id="txt_ref_number_for_discount" type="text" aria-describedby="Ref Number" placeholder="Enter Reference/Job Number" required="">
								</div>
								<div class="col-sm-5">
