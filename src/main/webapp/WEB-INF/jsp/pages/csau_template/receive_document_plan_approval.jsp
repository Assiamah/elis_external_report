        ...
        <div class="col-lg-7">
		 ...
		 <div class="card mb-3">
            <div class="card-header">
            	<h3 class="text-primary">Receive Hard Copy/Supplementary Document</h3>
            </div>
            ...
            <div class="card-body"> 				     
	               <div class="form-group">
							<div class="form-row">
								<div class="col-sm-7">
									<input class="form-control" id="txt_job_number_for_receive" type="text" aria-describedby="Job Number" placeholder="Enter Job Number" required value='LVDGAST325841752021'>
								</div>
								<div class="col-sm-5">
									<button class="btn btn-success btn-icon-split float-right  btn-lg" id="btn_load_bill_details_plan_approval_receive" >
											<span class="icon text-white-50"> <i class="fa fa-search"></i></span><span class="text">Search </span>
										</button>
								</div>
							</div>
					</div>
					<div  id="job_details_section"></div>			          
      		</div>
