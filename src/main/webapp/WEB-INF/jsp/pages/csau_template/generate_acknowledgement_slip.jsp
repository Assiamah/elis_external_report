  ...
  <jsp:include page="../includes/_header.jsp"></jsp:include>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Generate Acknowledgement Slip - ${fullname}</h1>
   ...
   <div class="card">
		        ...
		        <h5 class="card-header" role="tab" id="headingThree">
		            <a class="collapsed d-block" data-toggle="collapse" data-parent="#accordion" href="#collapsepocessingoncase" aria-expanded="false" aria-controls="collapseThree">
		                <i class="fa fa-chevron-down pull-right"></i> <i class="fas fa-file-alt"></i>  Generate Acknowledgement Slip
		            </a>
		        </h5>
		        <div id="collapsepocessingoncase" class="show1" role="tabpanel" aria-labelledby="headingThree">
		            <div class="card-body">
				            ...
				            <div class="card-body">
						      ...
						      <div class="form-group">
								<div class="form-row">
									...
									<div class="col">
										<button class="btn btn-success btn-icon-split float-right  btn-lg" id="btn_search_job_number_for_acknowledgement_slip" >
