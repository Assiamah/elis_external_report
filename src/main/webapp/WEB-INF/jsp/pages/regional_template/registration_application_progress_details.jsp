            ...
            <ul class="d-none">
              ...
              <!--   <li><a href="#link-1">Upload file at CSAU Back Office<br /><small>Upload file at CSAU Back Office</small></a></li> -->
               ...
               <!--  <li><a href="#link-2">File Created <br /><small>Generate LRD File Number</small></a></li> -->
                ...
                <li><a href="#link-3">Publication/Parcel Plan Preparation<br /><small>Publication/Parcel Plan Preparation</small></a></li>
             <!--    <li><a href="#link-4">Parcel Plan Preparation<br /><small>Parcel Plan Preparation</small></a></li>
 -->
                <li><a href="#link-4">Final Approval after Publication<br /><small>Final Approval after Publication</small></a></li>
                <li><a href="#link-5">Preparation  Certificate and Land Register<br /><small>Entering of Root of Title</small></a></li>
                <li><a href="#link-6">Generate Certificate and Land Register<br /><small>Certificate and Land Register Preparation</small></a></li>
                <li><a href="#link-7">Activate Parcel<br /><small>Activating Parcel</small></a></li>
			            ...
			            <!-- Maps Details Starts Here  -->
			              ...
			              <div class="form-group">
											        <div class="form-row">  <label for="lc_bl_wkt_polygon">WKT Polygon</label>
											              <input class="form-control" id="lc_bl_wkt_polygon" readonly  name="lc_bl_wkt_polygon"  type="text" aria-describedby="nameHelp"  value="${parcel_wkt}" >
				...
				<div class="col-lg-12">
					...
					<div class="card mb-3">
				      ...
				      <!--   Here is the end of right table -->
                       ...
                       <div id="link-3" class="">
                    <h3 class="border-bottom border-gray pb-2">Approve for Publication/Parcel Plan Preparation</h3>
