...
<div class="modal fade bd-example-modal-xl" tabindex="-1"
	id="newcomparabledata" role="dialog"
			...
			<div class="modal-body">
				...
				<form method="POST" action="Maps" target="_blank" id="downloadForm">
					...
					<div class="container">
						<div class="row">
							<div class="col">
								...
								<div class="form-group">
									...
									<div class="form-row">
										...
										<div class="col">
											<label for="cbl_type_of_house">Type of House</label>
									...
									<div class="form-row">
										...
										<div class="col">
											<label for="bl_ar_name">Type of Use</label>
												...
												<div class="form-group">
													<label for="bl_business_process_sub_name">Source of Verification</label>
													<textarea rows="2" class="form-control" placeholder=""
														id="cbl_source_of_verification"
													></textarea>
												</div>
							...
							<div class="col">
												...
												<div class="form-group">
													<div class="form-row">
														<div class="col">
																<label for="bl_ar_name">Currency of Value</label>
													
																<input
																	class="form-control " type="text" placeholder=""
																	id="cbl_currency_of_value"
																>
														</div>
														
														<div class="col">
																<label for="bl_ar_name">Capital Value</label>
													
																<input
																	class="form-control " type="text" placeholder=""
																	id="cbl_capital_value"
																>
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="form-row">
														<div class="col">
																<label for="bl_ar_name">Ground Rent</label>
														...
														<div class="col">
																<label for="bl_ar_name">Rental Value</label>
												...
												<div class="form-group">
													<div class="form-row">
														<div class="col">
																<label for="bl_ar_name">Commencement Date</label>
													
																<input
																	class="form-control " type="text" placeholder=""
																	id="cbl_commencement_date"
																>
														</div>
														
														<div class="col">
																<label for="bl_ar_name">Image Path</label>
												...
												<div class="form-group">
													...
													<button type="button"
									id="btn_save_comparable_main_changes_new"
						...
						<button type="button" class="btn btn-primary"  id="add_new_constructional_details" data-placement="top" data-toggle="modal" data-target="#newcomparableconstructionaldetails" data-toggle="tooltip" title="Upload CSV">
