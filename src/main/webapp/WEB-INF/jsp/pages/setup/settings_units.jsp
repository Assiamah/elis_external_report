	        ...
	        <div class="col-md-8">
	          ...
	          <div class="card mb-3">
	            <div class="card-header  bg-secondary text-light ">
              		<div class= "row">
	              		<div class="col-auto"><h3>Units </h3></div>
	              			<div class="col">
	              				<div class="form-row float-right">
				        	  		<label class="col-auto">Region: </label> 
				        	  		<select
												id="district_region_office_units" class="form-control input-sm col"
											>
	              		...
	              		<div class="col-sm-3"><a href="" class="float-right text-light" data-loc_id="0" data-loc_name=""  data-target="#editUnitModal" data-toggle="modal" >
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title custom_align" id="Heading">Add/Edit Unit</h4>
			</div>
			<form id="frmEditUnit">
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="bl_job_purpose">Unit Name</label>
							<textarea rows="2" class="form-control" placeholder="" required style="text-transform:uppercase"
								id="un_unit_name"
							></textarea>
						</div>
						
						<div class="form-group">
							<label for="bl_job_purpose">Divisions </label>
							<textarea rows="2" class="form-control" placeholder="" required style="text-transform:uppercase"
								id="un_divisions"
							></textarea>
						</div>
						...
						<div class="form-group ">
							<label > Status </label>
							<select  class="form-control"  id="un_status">
