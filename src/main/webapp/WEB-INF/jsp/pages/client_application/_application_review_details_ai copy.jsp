        ...
        opacity: 0 !important; /* Hide the backdrop to allow interaction */
                ...
                <!-- <div id="step-1" class=""> -->
			                    ...
			                    <!-- <h3 class="border-bottom border-gray pb-2">Records Information Search</h3>
			                     -->
			                       <!-- <fmt:parseNumber var="msAutoInt" value="${mileStone.ms_auto}" integerOnly="true" />
                                                            <c:if test="${fn:contains(validIds, msAutoInt)}"> -->
                                                               <!-- </c:if> -->
                           <c:set var="validIds" value="${all_milestone}" />


                                 <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header h5">Application Process(Review)</div>
                                            <div class="card-body">
                                        

                                              <!-- Chat Section (Bootstrap 4 Version) -->

<!-- Selected Ticket Details -->
<div class="px-3 py-2 bg-light border-bottom" id="recordDetails">
  <i class="fas fa-info-circle mr-1 text-secondary"></i>
  <div><strong>Job Number:</strong> ${job_number}</div>
  <div><strong>Applicant:</strong> ${ar_name}</div>
  <div><strong>Service Type:</strong> ${business_process_sub_name}</div>
</div>

<input type="hidden" id="job_number_in" />

<!-- Chat Messages Area -->
<div class="p-3" id="chatBox">
  <!-- Messages appended dynamically -->
</div>

<!-- Typing Indicator -->
<div class="px-3 py-2 text-muted" id="typingIndicator" style="display: none;">
  <i class="fas fa-spinner fa-spin mr-2"></i> Agent is typing...
</div>

<!-- Error Message -->
<div class="px-3 py-2 text-danger" id="errorMessage" style="display: none;"></div>

<!-- Input Area -->
<div class="p-3 bg-white d-flex align-items-center">
  <input type="text" class="form-control mr-2" id="userInput" placeholder="Type your message..."
    onkeypress="handleKeyPress(event)">
  <button class="btn btn-success" id="btn_generate_ai_message">
...
<div class="p-3 bg-light border-top border-success">
 
   <label for="cbo_predefine_messages_to_ai" class="form-label font-weight-bold">
    <i class="fas fa-window-restore mr-2 text-success"></i>View Related Info:
  </label>
  <select class="form-control mb-3" id="cbo_predefine_messages_to_ai">
    ...
    <option value="csertificate preparation">Certificate Preparation</option>
  </select>
 
  <label for="pageSelector" class="form-label font-weight-bold">
    <i class="fas fa-window-restore mr-2 text-success"></i>View Related Info:
  </label>
  <select class="form-control mb-3" id="pageSelector">
    <option value="">-- Select a Page --</option>
    <option value="communications.html">Communications</option>
    <option value="history.html">Task History</option>
    <option value="documents.html">Attached Documents</option>
    <option value="workflow.html">Workflow Timeline</option>
  </select>

  <div id="embeddedPageContainer" class="border p-3 bg-white" style="min-height: 250px;">
    <em class="text-muted">Select a page from the dropdown to load its content here.</em>
  </div>
</div>
...
<div class="row mt-5">
  ...
  <div class="col-3">
    <button class="btn btn-warning"  data-job_number="${job_number}" id="btn_completed_my_work">
      <span class="icon text-white-50"> <i class="fas fa-check fa-2x"></i></span><span class="text">Complete My Work</span>
    </button>
  </div>

  <div class="col-3">
    <button class="btn btn-primary w-100 to_hide_on_level_1" id="btn_process_complete_milestone">
      <i class="fas fa-list mr-1"></i>Complete Milestone
  </button>
    </div>

<div class="col-3">
<!-- <button class="btn w-100 btn-success"><i class="fas fa-check-circle mr-1"></i>ADD TO BATCH LIST</button> -->
<button class="btn w-100 btn-success btnAddToBatchlist"  data-job_number="${job_number}" data-ar_name="${ar_name}"
 ...
 <div class="col-3">
    ...
    <button class="btn btn-primary w-100" id="btnViewBatchlist">
...
<script>
    ...
    function reviewStep(stepId,job_number) {
