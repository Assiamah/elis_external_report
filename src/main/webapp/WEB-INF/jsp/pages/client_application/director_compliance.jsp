...
body.monitor-active .monitor-chart-card .card-body {
    flex: 1 1 auto;
    min-height: 0;
    overflow: hidden;
}

body.monitor-active #monitorStatsRow {
    flex: 0 0 auto;
}

body.monitor-active #monitorDashboard > .row.flex-grow-1 {
    flex: 1 1 auto;
    min-height: 0;
}

body.monitor-active #monitorDashboard > .row.flex-grow-1 > [class*="col-"],
body.monitor-active #monitorDashboard > .row.flex-grow-1 .row.h-100,
body.monitor-active #monitorDashboard > .row.flex-grow-1 .row.h-100 > [class*="col-"] {
    min-height: 0;
}
...
body.monitor-active .division-progress-item .division-label span:first-child {
    flex: 1 1 auto;
    min-width: 0;
    white-space: nowrap;
    overflow: hidden;
...
body.monitor-active .division-progress-item .division-label span:last-child {
    flex: 0 0 auto;
}
...
body.monitor-active .monitor-region-list {
    height: 100%;
    overflow: hidden;
}

body.monitor-active .monitor-region-summary {
    display: flex;
    justify-content: space-between;
    align-items: center;
    margin-bottom: 0.85rem;
...
body.monitor-active .monitor-region-summary-label {
    font-size: 0.72rem;
    font-weight: 700;
    color: #64748b;
...
body.monitor-active .monitor-region-summary-value {
    font-size: 1.15rem;
    font-weight: 700;
    color: #0f172a;
}

body.monitor-active .monitor-region-items {
    display: flex;
    flex-direction: column;
    gap: 0.65rem;
}

body.monitor-active .monitor-region-footnote {
    margin-top: 0.85rem;
    font-size: 0.74rem;
    color: #64748b;
    text-align: right;
