...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
   ...
   <h3 class="border-bottom border-gray pb-2">Volume and Folio Generation</h3>
						  ...
						  <div class="col-lg-12">
							...
							<div class="card mb-3">
							  <div class="card-header">
								<i class="fa fa-pie-chart"></i>Generate Volume and Folio</div>
							  <div class="card-body">
								 ...
								 <div class="col-md-6">
								  ...
								  <input class="form-control" id="lc_txt_folio_number"  name="file_number"  type="text" aria-describedby="nameHelp"  value="${folio_number}" >
									...
									<label for="job_number">.</label>
									 <input type="button" id="lc_btn_generate_certificate_volume_folio_tcs" class="btn btn-primary btn-block" value="Generate Indices" />  
								  </div>
