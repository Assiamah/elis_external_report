...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
   ...
   <jsp:include page="../client_application/_application_process_header.jsp"></jsp:include>
        ...
        <div id="smartwizardfirstregistration">
            <ul class="d-none">
              ...
              <!--   <li><a href="#link-1">Upload file at CSAU Back Office<br /><small>Upload file at CSAU Back Office</small></a></li> -->
               ...
               <!--  <li><a href="#link-2">File Created <br /><small>Generate LRD File Number</small></a></li> -->
                ...
                <li><a href="#link-3">Publication<br /><small>Publication</small></a></li>
                <li><a href="#link-4">Parcel Plan Preparation<br /><small>Parcel Plan Preparation</small></a></li>

                <li><a href="#link-5">Final Approval after Publication<br /><small>Final Approval after Publication</small></a></li>
                <li><a href="#link-6">Preparation  Certificate and Land Register<br /><small>Entering of Root of Title</small></a></li>
                <li><a href="#link-7">Generate Certificate and Land Register<br /><small>Certificate and Land Register Preparation</small></a></li>
                <li><a href="#link-8">Activate Parcel<br /><small>Activating Parcel</small></a></li>
            ...
            <%--   <div id="link-2" class="">
                    <h3 class="border-bottom border-gray pb-2">Generate LRD File Number</h3>
				          ...
				          <div class="card mb-3">
				            ...
				            <div class="form-row">
				              ...
				              <div class="col-md-6">
				                ...
				                <button type="button" class="btn btn-info form-control" id="btn_generate_case_file_number" data-placement="top"  data-toggle="tooltip" title="Generate Number">
					            <i class="fa fa-plus-circle"></i> Generate Number
					        </button>
				...
				<div class="col-lg-12">
					...
					<div class="card mb-3">
				      ...
				      <!--   Here is the end of right table -->
                       ...
                       <div id="link-3" class="">
                    <h3 class="border-bottom border-gray pb-2">Approve for Publication</h3>
					         ...
					         <input class="form-control" id="lc_fr_bl_wkt_polygon"  name="lc_fr_bl_wkt_polygon"  type="text" aria-describedby="nameHelp"  value="${parcel_wkt}" >
				              ...
				              <div class="col-md-4">
				               ...
				               <div class="col-md-4">
				                ...
				                <input class="form-control" id="txt_lc_ltr_plan_no"  name="search_value"  type="text" aria-describedby="nameHelp" placeholder="Enter Term" value="${ltr_plan_no}" readonly>
