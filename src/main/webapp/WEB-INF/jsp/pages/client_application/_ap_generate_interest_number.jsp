...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
   ...
   <h3 class="border-bottom border-gray pb-2">Generate Interest Number</h3>
   ...
   <div class="form-row mt-5">
	...
	<div class="col-md-4">
	 <!-- <label for="search_value">Interest Number</label> --> 
	  <input type="text" name="lc_txt_interest_number" id="lc_txt_interest_number" placeholder="Interest Number" readonly  class="form-control" value="${interest_number}"required> </div>
	<div class="col-md-4">
   <input type="button" id="lc_btn_generate_interest_number" class="btn btn-primary btn-block" value="Generate Interest Number"/> 
