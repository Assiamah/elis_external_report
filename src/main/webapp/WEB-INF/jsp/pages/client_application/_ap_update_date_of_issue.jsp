...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
   ...
   <h3 class="border-bottom border-gray pb-2">Update Date of Issue</h3>
   ...
   <div class="form-row mt-5">
	...
	<div class="col-md-4">
	 <!-- <label for="search_value">Interest Number</label> --> 
	  <input type="date" name="lc_txt_date_of_issue" id="lc_txt_date_of_issue" placeholder="Registered Number"  class="form-control" value="${date_of_issue}"required> </div>
	<div class="col-md-4">
   <input type="button" id="lc_btn_update_date_of_issue" class="btn btn-primary btn-block" value="Save"/> 
