						...
						<div class="card-body">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label for="">Regional Number</label> <input type="text"
												...
												placeholder="Regional Number"  readonly
											>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group">
										        ...
										        <input  type="number" step=".001" class="form-control" id="fe_land_size" placeholder="size in Acreage" readonly aria-describedby="inputGroupPrepend">
										...
										<div class="form-group">
											...
											<label for="">Nature of Instrument</label> <input type="text"
												class="form-control" id="fe_nature_of_instrument" readonly
							...
							<div class="form-group">
										...
										<label for="">Type of Use</label> <input type="text"
												class="form-control" id="fe_type_of_use" readonly
										...
										<div class="form-group">
											<label for="">Type of Interest</label> <select
												class="form-control" id="fe_type_of_interest"  readonly
											>
										...
										<div class="form-group">
											...
											<div class="input-group">
										        ...
										        <input type="number" step=".001" class="form-control" id="fe_consideration_fee"  placeholder="amount in GHS" readonly aria-describedby="inputGroupPrepend" value="0.00">
										        <div class="invalid-feedback">
										...
										<div class="form-group">
											<label for="">Date of Document </label> <input type="date"
												class="form-control " id="fe_date_of_document" placeholder="" readonly
												required
											>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="fe_registry_mapref" placeholder="" readonly>
										</div>
									</div>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label for="">Locality</label> <input type="text" class="form-control" readonly
												id="fe_locality"  
											>
										...
										<div class="form-group">
											<label for="">District</label> <input type="text" class="form-control" readonly
												id="fe_district"  
											>
										...
										<div class="form-group">
											<label for="">Region</label> <input type="text" class="form-control" readonly
												id="fe_region"  
											>
										...
										<div class="form-group">
											<label for="inputEmail4">Term </label> <input type="number"
												step=".001" class="form-control" id="fe_term" placeholder="Term" readonly
												
											>
										</div>
										<div class="form-group">
											<label for="">Option to Renew</label> <input type="text"
												class="form-control" id="fe_renewal_term" placeholder="" readonly
										...
										<input type="hidden"
												...
												placeholder="Stool/Family Name"   readonly
											>
										

										<input type="hidden"
												class="form-control" id="fe_grantor_family" placeholder="" readonly
												
											>

										<div class="form-group">
											<label for="">Extent</label> <input type="text"
												class="form-control" id="fe_extent" placeholder=""  readonly
											>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group">
										        ...
										        <input value="0" type="number" step=".001" class="form-control" id="fe_annual_rent"  placeholder="amount in GHS" readonly aria-describedby="inputGroupPrepend" value="o0.00">
										        <div class="invalid-feedback">
										          Please enter Rent.
										        </div>
										      </div>
										...
										<div class="form-group">
											<label for="inputEmail4">File Number</label> <input
												...
												placeholder="File number" required  readonly
											>
										</div>
