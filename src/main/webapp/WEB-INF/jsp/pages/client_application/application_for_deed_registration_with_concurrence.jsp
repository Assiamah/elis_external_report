...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
   ...
   <jsp:include page="../client_application/_application_process_header.jsp"></jsp:include>
        ...
        <div id="smartwizardfirstregistration">
              ...
              <!--   <li><a href="#link-1">Upload file at CSAU Back Office<br /><small>Upload file at CSAU Back Office</small></a></li> -->
               ...
               <!--  <li><a href="#link-2">File Created <br /><small>Generate LRD File Number</small></a></li> -->
                ...
                <li><a href="#link-2">Approval/Vetting<br /><small>Approval/Vetting</small></a></li>
                 <li><a href="#link-3">Preparation Concurrence Certificate<br /><small>Preparation Concurrence Certificate</small></a></li>
                 <li><a href="#link-4">Preparation Deed Certificate<br /><small>Preparation Deed Certificate</small></a></li>
            ...
            <li><a href="#link-6">Final Approval of Parcel<br /><small>Final Approval of Parcel</small></a></li>
  ...
  <option value="20000">20000</option>
   ...
   <div class="btn-group mr-2">
         ...
         <div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-12">
 				...
 				<%--  <div class="row">
                   ...
                   <div id="link-3" class="">
                 <h3 class="border-bottom border-gray pb-2">Preparation of Concurrence Certificate</h3>
           ...
           <div class="form-row">
							              <div class="col-md-12">
							                <label for="search_value">Concurrence Certificate Summary</label>
											 
											
											 
											    <textarea id="lc_search_report_summary_details_dcs" name="lc_search_report_summary_details_dcs" class="form-control col-sm-12" required rows=7  style="padding:50px !important;">${smd_licensed_surveyor_name} </textarea> 
							            ...
							            <div class="form-row">
							              ...
							              <div class="col-auto">
									              <br><br>									                 
						               					...
						               					<button type="button" name="btn_compose_certificate_template_dcs" id="btn_compose_certificate_template_dcs" class="btn  btn-primary btn-icon-split "  >
							                 ...
							                 <div class="col">
							              			<br><br>
						               				...
						               				<button type="button" name="lc_btn_save_search_report_dcs" id="lc_btn_save_search_report_dcs" 
							                ...
							                <div class="col">
							              			<br><br>
							                		<button type="button" name="lc_btn_preview_consent_certificate_dcs" id="lc_btn_preview_consent_certificate_dcs" class="btn  btn-primary btn-icon-split "  >
