...
<div id="smartwizardfirstregistration">
	<ul class="d-none">
		...
		<li><a href="#53ab3caa7e7d11ef98b51e576becd20e-2">Assessment<br /> <small>Assessment</small></a></li>
		<li><a href="#53ab3caa7e7d11ef98b51e576becd20e-3">Embossment after Payment<br /> <small>Embossment after Payment</small></a></li>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="card mb-10">
						<div class="card-header">
							<i class="fa fa-pie-chart"></i>Comparable Data
						</div>
						<div class="card-body">
							<!--  The Form starts here -->
							<div id="alert-display-space"></div>
							<form action="" method="post" id="form_comparable">
								...
								<div class="form-group row">
									...
									>Is the Land Developed ?</label>
									<div class="col">
										<div class="input-group">
											<div id="radioBtn" class="btn-group">
												<a class="btn btn-primary btn-sm notActive"
													data-toggle="land_state" data-title="Yes"
												>YES</a> <a class="btn btn-primary btn-sm notActive"
													data-toggle="land_state" data-title="No"
												>NO</a>
											</div>
								...
								<div id="comparable_section_display" style="display: none">
									...
									<div class="form-group row">
										<label for="assessed_value" class="col-sm-3 col-form-label"
											style="text-align: right"
										>Locality/Land Size :</label>

										<div class="col-sm-5">
											<div class="input-group mb-2">
												<div class="input-group-prepend">

													<button type="button" name="btn_load_comparable_values"
												...
												<input readonly class="form-control input-sm"
													id="new_comparable_locality" type="text"
													value="${locality}"
												> <input readonly class="form-control input-sm"
													id="new_comparable_size_of_land" type="text"
													value="${size_of_land}"
												>
											</div>
									...
									<div class="form-group row">
										<label for="stamp_duty" class="col-sm-3 col-form-label"
											style="text-align: right"
										...
										<div class="col-sm-5">
											...
											<div class="input-group mb-2">
												...
												<input type="text" id="txt_comp_max_value"
													name="txt_comp_max_value" class=" form-control  " required
									...
									<div class="form-group row">
										<label for="stamp_duty" class="col-sm-3 col-form-label"
											style="text-align: right"
										>Max Value <span class="text-danger">*</span>:</label>
										<div class="col-sm-5">
											...
											<div class="input-group mb-2">
												...
												<input  type="text" id="txt_comp_min_value"
													name="txt_comp_min_value" class=" form-control  " required
													placeholder="Min Vale"
												>
											</div>
							...
							<form action="" method="post" id="form_assessment">
								...
								<div id="alert-display-space1"></div>
				               		...
				               		<div class="form-group row bg-secondary text-light" >
										...
										<div class="col-sm-6">
											<label for="adopted_value"  >Consideration :</label>
											<div class="input-group mb-2">
												<div class="input-group-prepend">
												...
												<input value="${consideration_fee}" step="0.1" type="number" class=" form-control  " 
													 placeholder="Consideration Amount" disabled
												>
											</div>	
										</div>										
										...
										<div class="col-sm-6">
											...
											<div class="input-group mb-2">
												...
												<input value="${considertion_fee_adopted_rate}" step="0.1" type="number" id="considertion_fee_adopted_rate" min="1.0"
													name="considertion_fee_adopted_rate" class=" form-control  "  step="0.01"
								...
								<%-- <div class="form-group row">
									...
									<label for="adopted_value" class="col-sm-4 col-form-label"
										style="text-align: right"
									>Currency Conversion Rate Used <span class="text-danger">*</span>:</label>
									<div class="col-sm-5">

										<div class="input-group mb-2">
											
											<input value="${considertion_fee_adopted_rate}" step="0.1" type="text" id="considertion_value"
												name="considertion_value" class=" form-control  " 
												required placeholder="Consideration Rate" 
											>
										</div>
								...
								<div class="form-group row">
									...
									<label for="adopted_value" class="col-sm-4 col-form-label"
										style="text-align: right"
									>Adopted Land Value /acre <span class="text-danger">*</span>:</label>
									<div class="col-sm-5">
								...
								<div class="form-group row">
									...
									<div class="col-sm-5">
										<textarea name="assessed_comment" id="assessed_comment"
											class=" form-control  " required
										>${stamp_duty_description}</textarea>
									</div>
								</div>
								<div class="form-group row">
