   ...
   <jsp:include page="../client_application/_application_process_header.jsp"></jsp:include>
        ...
        <div id="smartwizardfirstregistration">
            <ul class="d-none">
                ...
                <li><a href="#53ab3caa7e7d11ef98b51e576becd20e-1">Vetting<br /><small>Vetting</small></a></li>
                <li><a href="#53ab3caa7e7d11ef98b51e576becd20e-2">Link Application to Mother File<br /><small>Link Application to Mother File</small></a></li>
                <li><a href="#53ab3caa7e7d11ef98b51e576becd20e-3">Final Approval of Registration<br /><small>Fnmal Approval of Registration</small></a></li>
						...
						<p data-placement="top" data-toggle="tooltip" title="Batch">
							...
							>
							  ...
							  <button type="button"
																				...
																				id="lc_btn_generate_memo_for_certificate_2" data-placement="top" 
																			>
