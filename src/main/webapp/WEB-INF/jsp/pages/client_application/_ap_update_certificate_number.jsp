...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
   ...
   <h3 class="border-bottom border-gray pb-2">Update Certificate Number</h3>
   ...
   <div class="form-row mt-5">
	...
	<div class="col-md-4">
	 <!-- <label for="search_value">Interest Number</label> --> 
	  <input type="text" name="lc_xxx_certificate_number" id="lc_xxx_certificate_number" placeholder="Certificate Number"   class="form-control" value="${certificate_number}"required> </div>
	<div class="col-md-4">
   <input type="button" id="lc_btn_generate_certificate_number" class="btn btn-primary btn-block" value="Update"/> 
