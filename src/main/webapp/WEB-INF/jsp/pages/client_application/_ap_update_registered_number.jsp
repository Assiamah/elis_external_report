...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
   ...
   <h3 class="border-bottom border-gray pb-2">Update Registered Number</h3>
   ...
   <div class="form-row mt-5">
	...
	<div class="col-md-4">
	 <!-- <label for="search_value">Interest Number</label> --> 
	  <input type="text" name="lc_txt_registered_number" id="lc_txt_registered_number" placeholder="Registered Number"  class="form-control" value="${registered_number}"required> </div>
	<div class="col-md-4">
   <input type="button" id="lc_btn_update_registered_number" class="btn btn-primary btn-block" value="Save"/> 
