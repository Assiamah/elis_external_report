...
<div class="form-row mt-5">
 ...
 <div class="mt-5">
	<button class="btn btn-success btn-icon-split float-left "  data-job_number="${job_number}" id="btnUpdateAsMotherFinalRegister">
		<span class="icon text-white-50"> <i class="fas fa-check fa-2x"></i></span><span class="text">Update As MotherFile</span>
	</button>

	<button class="btn btn-danger btn-icon-split float-left ml-3" id="lc_btn_generate_updated_mother_final_register">
		<span class="icon text-white-50"> <i class="fas fa-eye fa-2x"></i></span><span class="text">Generate Register</span>
	</button>
 </div>
