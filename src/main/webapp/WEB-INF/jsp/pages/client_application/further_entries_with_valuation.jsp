				...
				<div class="card mb-3">
					...
					>
						<div class="card-body">
							...
							<form id='frmFurtherEntriesWithValuation'>
							...
							<div class="form-group">
                                ...
                                <hr>
                                <h5><b>Valuation Details</b></h5><br>
                                <div class="form-row">
                                    <div class="col-md-6">
										<!-- <div class="form-group">
											<label for="inputEmail4">Date of Valuation</label> <input
												type="date" class="form-control" id="fe_date_of_valuation"
												 required
											>
										</div> -->
                                        ...
                                        <div class="form-group">
											...
											<div class="input-group">
										        ...
										        <input type="number" step=".001" class="form-control" id="fe_amount"  placeholder="amount in GHS" aria-describedby="inputGroupPrepend" value="0.00">
										        <div class="invalid-feedback">
										          Please enter Consideration.
										        </div>
										      </div>
                                    ...
                                    <div class="col-md-6">
										<div class="form-group">
											<label for="inputEmail4">Remarks</label> <textarea
												type="date" class="form-control" id="fe_remarks"
								...
								<hr>
                                <h5><b>Certificate Details</b></h5><br>
                                <div class="form-row">
                                    <div class="col-md-6">
										<!-- <div class="form-group">
											<label for="inputEmail4">Date of Valuation</label> <input
                                        ...
                                        <div class="form-group">
											<label for="inputEmail4">Certificate Number</label> <input
												type="text" class="form-control" id="fe_certificate_number"
												placeholder=""
											>
										</div>
