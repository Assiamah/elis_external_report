        ...
        <!-- <div id="smartwizardfirstregistration">
            <ul> -->
              ...
              <!--   <li><a href="#step-1">Upload file at CSAU Back Office<br /><small>Upload file at CSAU Back Office</small></a></li> -->
               ...
               <!--  <li><a href="#step-2">File Created <br /><small>Generate LRD File Number</small></a></li> -->
                <!-- <li><a href="#step-1">Coordinate Entry and Record Verification<br /><small>Coordinate Entry and Record Verification</small></a></li>
            ...
            <!-- <div>
                ...
                <div id="step-10" class=""> -->
			                    ...
			                    <input type="hidden" id="division_layer" value="${division}"/>
			                      <div class="row">
   ...
   <div class="btn-group mr-2">
											...
											<div class="col-12">
												<div class="card card-body">
													<h5>More than One overlay</h5>
													  ...
													  <table class="table table-bordered" id="lc_more_than_one_parcel_Table" width="100%" cellspacing="0">
	...
	<div class="card card-body">
		...
		<div class="card card-body">
        	...
        	<button class="btn btn-warning btn-icon-split float-left to_hide_on_level_2"  data-job_number="${job_number}" id="btnCompleteJobfrrv_we">
					<span class="icon text-white-50"> <i class="fas fa-check fa-2x"></i></span><span class="text">Complete My Work</span>
				</button>
				
				<button class="btn btn-success btn-icon-split float-left to_hide_on_level_1"  data-job_number="${job_number}" id="btnApproveJobfrrv_we">
