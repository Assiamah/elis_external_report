            ...
            <div>
             ...
             <%--    <div id="link-1" class="">
		         ...
		         <button type="button" class="btn btn-primary" id="btn_load_scanned_documents" data-placement="top"  title="Load Docs">
                    ...
                    <div id="link-1" class="">
                    <h3 class="border-bottom border-gray pb-2">Coordinate Entry and Record Verification</h3>
                     ...
                     <!--   Here is the right Table -->
				        <div class="col-lg-8">
				          ...
				          <div class="card mb-3">
				            <div class="card-header">
				              <i class="fa fa-pie-chart"></i>Coordinate Entry and Record Verification</div>
				            <div class="card-body">
				               <!--  The Form starts here -->
				       ...
				       <!--   Here is the right Table -->
				        <div class="col-lg-12">
				          ...
				          <div class="card mb-10">
				            <div class="card-header">
				              <i class="fa fa-pie-chart"></i>Letter to District Assembly for Subdivision </div>
				            <div class="card-body">
				               <!--  The Form starts here -->
					       ...
					       <select name="lc_letter_type" id="lc_letter_type" data-live-search="true" data-none-results-text="I found no results" title="Please select Letter type" class="form-control selectpicker">
							<option value="Planning Comments Letter">Letter to District Assembly for Subdivision </option>
				            ...
				            <div class="form-row">
				             ...
				             <form action="${pageContext.request.contextPath}/GenerateCaseReports"  method="post" target="_blank">
						          ...
						          <div class="col-md-12">
						                ...
						                <input type="submit" class="btn btn-primary btn-block" value="Generate Letter to District Assembly for Subdivision " />  
						 ...
						 <div class="row">
						      ...
						      <!--   Here is the end of right table -->
						       ...
						       <div class="form-row">
				 				...
				 				<div class="col-md-12">
				               <input type="button" id="lc_btn_preview_consent_certificate" class="btn btn-primary btn-block" value="Preview Certificate" /> 
